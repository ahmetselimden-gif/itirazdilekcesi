...
const requiredFields: Array<keyof KiraciRequest> = [
  "fullName",
  "address",
  "counterpartyName",
  "rentedAddress",
...
export async function POST(request: Request) {
  const body = (await request.json()) as KiraciRequest;
...
${body.problemType} nedeniyle kiracı tarafından itiraz dilekçesi
...
2. UYUŞMAZLIĞIN ÖZÜ:
   ...
   Belirtilen konu, kiracılık ilişkisinin devamı ve korunması açısından
